...
Note: Since November 2022, the Google Playstore has refused to accept updates from Termux, so downloading Termux from there won't work. You can download the latest version of Termux from [https://f-droid.org/en/packages/com.termux/](https://f-droid.org/en/packages/com.termux/). F-Droid is a repository of free and open source software for Android devices. You can download the F-Droid app from here [https://f-droid.org/en/](https://f-droid.org/en/).
