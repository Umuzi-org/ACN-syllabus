...
Create a branch. In your branch add a markdown file. This is a plain text file with the extension `.md`. You can create one of these with any text editor. We'll learn more about markdown later, it's a useful tool for documenting projects.
