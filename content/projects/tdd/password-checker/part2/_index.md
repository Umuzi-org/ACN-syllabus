...
In part one of this exercise you created two functions. Now you are going to upgrade that program by adding some logging capabilities using the specified logger for the programming language used. E.g, if you are using java, please use log4J-2.
