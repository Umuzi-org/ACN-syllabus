...
You then conduct your empathising with office staff and the cleaning staff. You find a few things:
...
**Model the existing process** – Use one of the techniques to put the process you’re working with down on paper or digitized using software.

**Identify inefficiencies and potential improvements** – Consider things like:
a. How well is the current process performing?
b. Is it efficient?
c. Is it meeting operational goals?
d. Are there any wasteful steps?

**Design the desired Process** – Here you will design a new and improved process factoring in your findings from step #2

**Implement the new Process** -  Put the new process into practice.
